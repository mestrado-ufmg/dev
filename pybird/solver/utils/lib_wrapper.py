...
def solve(type: int,
    ...
    facesCenter = facesCenter.astype(double)
    controlPoints = controlPoints.astype(double)
    p1 = p1.astype(double)
    p2 = p2.astype(double)
    p3 = p3.astype(double)
    e1 = e1.astype(double)
    e2 = e2.astype(double)
    e3 = e3.astype(double)
    leftWingGrid = leftWingGrid.astype(int32)
    leftWingVertices = leftWingVertices.astype(double)
    leftWingFaces = leftWingFaces.astype(int32)
    rightWingGrid = rightWingGrid.astype(int32)
    rightWingVertices = rightWingVertices.astype(double)
    rightWingFaces = rightWingFaces.astype(int32)
    tailGrid = tailGrid.astype(int32)
    tailVertices = tailVertices.astype(double)
    tailFaces = tailFaces.astype(int32)
    ...
    # Load library
    lib = CDLL('./pybird/solver/utils/bin/libsolver.so')
