...
void solveBoundaryLayer(int nf,
    ...
    double *inc_values = (double *)calloc(6 * nf, sizeof(double));
    ...
    for (i = 0; i < int_max; i++) {
        ...
        for (j = 0; j < nf; j++) {
            ...
            obj_func_comp[0] = max_momentum_x_aux;
            obj_func_comp[1] = max_momentum_y_aux;
            obj_func_comp[2] = max_kinetic_energy_aux;
            obj_func_comp[3] = max_lateral_curvature_aux;
            obj_func_comp[4] = max_shear_stress_x_aux;
            obj_func_comp[5] = max_shear_stress_y_aux;
            ...
            obj_func_comp[6] = max_momentum_x_aux;
            obj_func_comp[7] = max_momentum_y_aux;
            obj_func_comp[8] = max_kinetic_energy_aux;
            obj_func_comp[9] = max_lateral_curvature_aux;
            obj_func_comp[10] = max_shear_stress_x_aux;
            obj_func_comp[11] = max_shear_stress_y_aux;
            ...
            obj_func_comp[12] = max_momentum_x_aux;
            obj_func_comp[13] = max_momentum_y_aux;
            obj_func_comp[14] = max_kinetic_energy_aux;
            obj_func_comp[15] = max_lateral_curvature_aux;
            obj_func_comp[16] = max_shear_stress_x_aux;
            obj_func_comp[17] = max_shear_stress_y_aux;
            ...
            obj_func_comp[18] = max_momentum_x_aux;
            obj_func_comp[19] = max_momentum_y_aux;
            obj_func_comp[20] = max_kinetic_energy_aux;
            obj_func_comp[21] = max_lateral_curvature_aux;
            obj_func_comp[22] = max_shear_stress_x_aux;
            obj_func_comp[23] = max_shear_stress_y_aux;
            ...
            obj_func_comp[24] = max_momentum_x_aux;
            obj_func_comp[25] = max_momentum_y_aux;
            obj_func_comp[26] = max_kinetic_energy_aux;
            obj_func_comp[27] = max_lateral_curvature_aux;
            obj_func_comp[28] = max_shear_stress_x_aux;
            obj_func_comp[29] = max_shear_stress_y_aux;
            ...
            obj_func_comp[30] = max_momentum_x_aux;
            obj_func_comp[31] = max_momentum_y_aux;
            obj_func_comp[32] = max_kinetic_energy_aux;
            obj_func_comp[33] = max_lateral_curvature_aux;
            obj_func_comp[34] = max_shear_stress_x_aux;
            obj_func_comp[35] = max_shear_stress_y_aux;
            ...
            obj_func_comp[36] = max_momentum_x_aux;
            obj_func_comp[37] = max_momentum_y_aux;
            obj_func_comp[38] = max_kinetic_energy_aux;
            obj_func_comp[39] = max_lateral_curvature_aux;
            obj_func_comp[40] = max_shear_stress_x_aux;
            obj_func_comp[41] = max_shear_stress_y_aux;
            ...
            for (k = 0; k < faces_connection[j].n; k++) {
                ...
                obj_func_comp[42 + 36 * k] = max_momentum_x_aux;
                obj_func_comp[42 + 36 * k + 1] = max_momentum_y_aux;
                obj_func_comp[42 + 36 * k + 2] = max_kinetic_energy_aux;
                obj_func_comp[42 + 36 * k + 3] = max_lateral_curvature_aux;
                obj_func_comp[42 + 36 * k + 4] = max_shear_stress_x_aux;
                obj_func_comp[42 + 36 * k + 5] = max_shear_stress_y_aux;
                ...
                obj_func_comp[42 + 36 * k + 6] = max_momentum_x_aux;
                obj_func_comp[42 + 36 * k + 7] = max_momentum_y_aux;
                obj_func_comp[42 + 36 * k + 8] = max_kinetic_energy_aux;
                obj_func_comp[42 + 36 * k + 9] = max_lateral_curvature_aux;
                obj_func_comp[42 + 36 * k + 10] = max_shear_stress_x_aux;
                obj_func_comp[42 + 36 * k + 11] = max_shear_stress_y_aux;
                ...
                obj_func_comp[42 + 36 * k + 12] = max_momentum_x_aux;
                obj_func_comp[42 + 36 * k + 13] = max_momentum_y_aux;
                obj_func_comp[42 + 36 * k + 14] = max_kinetic_energy_aux;
                obj_func_comp[42 + 36 * k + 15] = max_lateral_curvature_aux;
                obj_func_comp[42 + 36 * k + 16] = max_shear_stress_x_aux;
                obj_func_comp[42 + 36 * k + 17] = max_shear_stress_y_aux;
                ...
                obj_func_comp[42 + 36 * k + 18] = max_momentum_x_aux;
                obj_func_comp[42 + 36 * k + 19] = max_momentum_y_aux;
                obj_func_comp[42 + 36 * k + 20] = max_kinetic_energy_aux;
                obj_func_comp[42 + 36 * k + 21] = max_lateral_curvature_aux;
                obj_func_comp[42 + 36 * k + 22] = max_shear_stress_x_aux;
                obj_func_comp[42 + 36 * k + 23] = max_shear_stress_y_aux;
                ...
                obj_func_comp[42 + 36 * k + 24] = max_momentum_x_aux;
                obj_func_comp[42 + 36 * k + 25] = max_momentum_y_aux;
                obj_func_comp[42 + 36 * k + 26] = max_kinetic_energy_aux;
                obj_func_comp[42 + 36 * k + 27] = max_lateral_curvature_aux;
                obj_func_comp[42 + 36 * k + 28] = max_shear_stress_x_aux;
                obj_func_comp[42 + 36 * k + 29] = max_shear_stress_y_aux;
                ...
                obj_func_comp[42 + 36 * k + 30] = max_momentum_x_aux;
                obj_func_comp[42 + 36 * k + 31] = max_momentum_y_aux;
                obj_func_comp[42 + 36 * k + 32] = max_kinetic_energy_aux;
                obj_func_comp[42 + 36 * k + 33] = max_lateral_curvature_aux;
                obj_func_comp[42 + 36 * k + 34] = max_shear_stress_x_aux;
                obj_func_comp[42 + 36 * k + 35] = max_shear_stress_y_aux;
            ...
            /* Calculate obj function components gradient */

            for (k = 0; k < (faces_connection[j].n + 1) * 6; k++) {
                grad_momentum_x[k] = (obj_func[6 + k * 6] - obj_func_comp[0]) / eps;
                grad_momentum_y[k] = (obj_func[7 + k * 6] - obj_func_comp[1]) / eps;
                grad_kinetic_energy[k] = (obj_func[8 + k * 6] - obj_func_comp[2]) / eps;
                grad_lateral_curvature[k] = (obj_func[9 + k * 6] - obj_func_comp[3]) / eps;
                grad_shear_stress_x[k] = (obj_func[10 + k * 6] - obj_func_comp[4]) / eps;
                grad_shear_stress_y[k] = (obj_func[11 + k * 6] - obj_func_comp[5]) / eps;
            }
