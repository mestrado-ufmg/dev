...
double dotVec(int n, double *a, double *b) {
    static double out = 0.0;
    for (int i = 0; i < n; i++) out = out + a[i] * b[i];
    return out;
}
...
struct Data {
    ...
    double *p1, *p2, *p3;
    double *e1, *e2, *e3;
    double *velx, *vely, *velz, *velNorm;
    double *transpiration;
    struct VerticeConnection *vertices_connection;
    struct FacesConnection *faces_connection;
    double *obj_func;
    double max_momentum_x_aux;
    double max_momentum_y_aux;
    double max_kinetic_energy_aux;
    double max_lateral_curvature_aux;
    double max_shear_stress_x_aux;
    double max_shear_stress_y_aux;
    double freestreamNorm;
    double eps;
};

void objFuncGradient(int n, struct Data data, double *grad) {

    int k;

    // Save params
    data.params_aux = data.params[data.face];

    //---------------------------//
    /*          delta            */
    //---------------------------//
    /* Add delta eps params */
    data.params[data.face] = data.params_delta_eps[data.face];

    /* Calculate divergent and gradient */
    calculateDivergents(data.face, data.faces, data.vertices_connection, data.params, data.facesArea[data.face], data.p1, data.p2, data.p3);
    calculateGradients(data.face, data.faces, data.vertices_connection, data.params, data.e1, data.e2, data.e3, data.p1, data.p2, data.p3, data.velNorm, data.velx, data.vely, data.velz, data.transpiration);

    /* Obj. func. with delta eps */
    calculateObjectiveFunction(data.params[data.face], &data.obj_func[1], &data.max_momentum_x_aux, &data.max_momentum_y_aux, &data.max_kinetic_energy_aux, &data.max_lateral_curvature_aux, &data.max_shear_stress_x_aux, &data.max_shear_stress_y_aux, data.freestreamNorm);

    //---------------------------//
    /*            A              */
    //---------------------------//
    /* Add delta eps params */
    data.params[data.face] = data.params_A_eps[data.face];
    ...
    /* Obj. func. with delta eps */
    calculateObjectiveFunction(data.params[data.face], &data.obj_func[2], &data.max_momentum_x_aux, &data.max_momentum_y_aux, &data.max_kinetic_energy_aux, &data.max_lateral_curvature_aux, &data.max_shear_stress_x_aux, &data.max_shear_stress_y_aux, data.freestreamNorm);

    //---------------------------//
    /*            B              */
    //---------------------------//
    /* Add delta eps params */
    data.params[data.face] = data.params_B_eps[data.face];
    ...
    /* Obj. func. with delta eps */
    calculateObjectiveFunction(data.params[data.face], &data.obj_func[3], &data.max_momentum_x_aux, &data.max_momentum_y_aux, &data.max_kinetic_energy_aux, &data.max_lateral_curvature_aux, &data.max_shear_stress_x_aux, &data.max_shear_stress_y_aux, data.freestreamNorm);

    //---------------------------//
    /*           Psi             */
    //---------------------------//
    /* Add delta eps params */
    data.params[data.face] = data.params_Psi_eps[data.face];
    ...
    /* Obj. func. with delta eps */
    calculateObjectiveFunction(data.params[data.face], &data.obj_func[4], &data.max_momentum_x_aux, &data.max_momentum_y_aux, &data.max_kinetic_energy_aux, &data.max_lateral_curvature_aux, &data.max_shear_stress_x_aux, &data.max_shear_stress_y_aux, data.freestreamNorm);

    //---------------------------//
    /*          Ctau1            */
    //---------------------------//
    /* Add delta eps params */
    data.params[data.face] = data.params_Ctau1_eps[data.face];
    ...
    /* Obj. func. with delta eps */
    calculateObjectiveFunction(data.params[data.face], &data.obj_func[5], &data.max_momentum_x_aux, &data.max_momentum_y_aux, &data.max_kinetic_energy_aux, &data.max_lateral_curvature_aux, &data.max_shear_stress_x_aux, &data.max_shear_stress_y_aux, data.freestreamNorm);

    //---------------------------//
    /*          Ctau2            */
    //---------------------------//
    /* Add delta eps params */
    data.params[data.face] = data.params_Ctau2_eps[data.face];
    ...
    /* Obj. func. with delta eps */
    calculateObjectiveFunction(data.params[data.face], &data.obj_func[6], &data.max_momentum_x_aux, &data.max_momentum_y_aux, &data.max_kinetic_energy_aux, &data.max_lateral_curvature_aux, &data.max_shear_stress_x_aux, &data.max_shear_stress_y_aux, data.freestreamNorm);

    data.params[data.face] = data.params_aux;

    /* Calculate objective function */
    for (k = 0; k < data.faces_connection[data.face].n; k++) {

        /* Save current face params */
        data.params_aux = data.params[data.faces_connection[data.face].faces[k]];
        ...
        /* Add delta eps params */
        data.params[data.faces_connection[data.face].faces[k]] = data.params_delta_eps[data.faces_connection[data.face].faces[k]];
        ...
        /* Obj. func. with delta eps */
        calculateObjectiveFunction(data.params[data.face], &data.obj_func[7 + 6 * k], &data.max_momentum_x_aux, &data.max_momentum_y_aux, &data.max_kinetic_energy_aux, &data.max_lateral_curvature_aux, &data.max_shear_stress_x_aux, &data.max_shear_stress_y_aux, data.freestreamNorm);
        ...
        /* Add delta eps params */
        data.params[data.faces_connection[data.face].faces[k]] = data.params_A_eps[data.faces_connection[data.face].faces[k]];
        ...
        /* Obj. func. with delta eps */
        calculateObjectiveFunction(data.params[data.face], &data.obj_func[7 + 6 * k + 1], &data.max_momentum_x_aux, &data.max_momentum_y_aux, &data.max_kinetic_energy_aux, &data.max_lateral_curvature_aux, &data.max_shear_stress_x_aux, &data.max_shear_stress_y_aux, data.freestreamNorm);
        ...
        /* Add delta eps params */
        data.params[data.faces_connection[data.face].faces[k]] = data.params_B_eps[data.faces_connection[data.face].faces[k]];
        ...
        /* Obj. func. with delta eps */
        calculateObjectiveFunction(data.params[data.face], &data.obj_func[7 + 6 * k + 2], &data.max_momentum_x_aux, &data.max_momentum_y_aux, &data.max_kinetic_energy_aux, &data.max_lateral_curvature_aux, &data.max_shear_stress_x_aux, &data.max_shear_stress_y_aux, data.freestreamNorm);
        ...
        /* Add delta eps params */
        data.params[data.faces_connection[data.face].faces[k]] = data.params_Psi_eps[data.faces_connection[data.face].faces[k]];
        ...
        /* Obj. func. with delta eps */
        calculateObjectiveFunction(data.params[data.face], &data.obj_func[7 + 6 * k + 3], &data.max_momentum_x_aux, &data.max_momentum_y_aux, &data.max_kinetic_energy_aux, &data.max_lateral_curvature_aux, &data.max_shear_stress_x_aux, &data.max_shear_stress_y_aux, data.freestreamNorm);
        ...
        /* Add delta eps params */
        data.params[data.faces_connection[data.face].faces[k]] = data.params_Ctau1_eps[data.faces_connection[data.face].faces[k]];
        ...
        /* Obj. func. with delta eps */
        calculateObjectiveFunction(data.params[data.face], &data.obj_func[7 + 6 * k + 4], &data.max_momentum_x_aux, &data.max_momentum_y_aux, &data.max_kinetic_energy_aux, &data.max_lateral_curvature_aux, &data.max_shear_stress_x_aux, &data.max_shear_stress_y_aux, data.freestreamNorm);
        ...
        /* Add delta eps params */
        data.params[data.faces_connection[data.face].faces[k]] = data.params_Ctau2_eps[data.faces_connection[data.face].faces[k]];
        ...
        /* Obj. func. with delta eps */
        calculateObjectiveFunction(data.params[data.face], &data.obj_func[7 + 6 * k + 5], &data.max_momentum_x_aux, &data.max_momentum_y_aux, &data.max_kinetic_energy_aux, &data.max_lateral_curvature_aux, &data.max_shear_stress_x_aux, &data.max_shear_stress_y_aux, data.freestreamNorm);

        /* Return to previous params */
        data.params[data.faces_connection[data.face].faces[k]] = data.params_aux;

    }

    /* Calculate obj function gradient */
    for (k = 0; k < n; k++) {
        grad[k] = (data.obj_func[1 + k] - data.obj_func[0]) / data.eps;
    }
...
void solveBoundaryLayer(int nf,
    ...
    double max_momentum_x;
    double max_momentum_y;
    double max_kinetic_energy;
    double max_lateral_curvature;
    double max_shear_stress_x;
    double max_shear_stress_y;
    ...
    data.e1 = e1; data.e2 = e2; data.e3 = e3;
    data.eps = eps;
    data.faces = faces;
    data.faces_connection = faces_connection;
    data.facesArea = facesArea;
    data.freestreamNorm = freestreamNorm;
    data.p1 = p1; data.p2 = p2; data.p3 = p3;
    data.params = params;
    data.params_delta_eps = params_delta_eps;
    data.params_A_eps = params_A_eps;
    data.params_B_eps = params_B_eps;
    data.params_Psi_eps = params_Psi_eps;
    data.params_Ctau1_eps = params_Ctau1_eps;
    data.params_Ctau2_eps = params_Ctau2_eps;
    data.transpiration = transpiration;
    data.velNorm = velNorm;
    data.velx = velx;
    data.vely = vely;
    data.velz = velz;
    data.vertices_connection = vertices_connection;

    double grad_norm;

    /* Faces connection */
    calculateFacesConnection(nv, nf, data.faces, data.vertices_connection, data.faces_connection);
    ...
    for (i = 0; i < int_max; i++) {
        ...
        for (j = 0; j < nf; j++) {
            ...
            calculateEquationsParams(norm_delta * norm_delta_list[j], norm_A * norm_A_list[j], norm_B * norm_B_list[j], norm_Psi * norm_Psi_list[j], norm_Ctau1 * norm_Ctau1_list[j], norm_Ctau2 * norm_Ctau2_list[j], &freestream, &profiles, &integralThickness, &integralDefect, &data.params[j]);
            calculateEquationsParams(norm_delta * (norm_delta_list[j] + eps), norm_A * norm_A_list[j], norm_B * norm_B_list[j], norm_Psi * norm_Psi_list[j], norm_Ctau1 * norm_Ctau1_list[j], norm_Ctau2 * norm_Ctau2_list[j], &freestream, &profiles, &integralThickness, &integralDefect, &data.params_delta_eps[j]);
            calculateEquationsParams(norm_delta * norm_delta_list[j], norm_A * (norm_A_list[j] + eps), norm_B * norm_B_list[j], norm_Psi * norm_Psi_list[j], norm_Ctau1 * norm_Ctau1_list[j], norm_Ctau2 * norm_Ctau2_list[j], &freestream, &profiles, &integralThickness, &integralDefect, &data.params_A_eps[j]);
            calculateEquationsParams(norm_delta * norm_delta_list[j], norm_A * norm_A_list[j], norm_B * (norm_B_list[j] + eps), norm_Psi * norm_Psi_list[j], norm_Ctau1 * norm_Ctau1_list[j], norm_Ctau2 * norm_Ctau2_list[j], &freestream, &profiles, &integralThickness, &integralDefect, &data.params_B_eps[j]);
            calculateEquationsParams(norm_delta * norm_delta_list[j], norm_A * norm_A_list[j], norm_B * norm_B_list[j], norm_Psi * (norm_Psi_list[j] + eps), norm_Ctau1 * norm_Ctau1_list[j], norm_Ctau2 * norm_Ctau2_list[j], &freestream, &profiles, &integralThickness, &integralDefect, &data.params_Psi_eps[j]);
            calculateEquationsParams(norm_delta * norm_delta_list[j], norm_A * norm_A_list[j], norm_B * norm_B_list[j], norm_Psi * norm_Psi_list[j], norm_Ctau1 * (norm_Ctau1_list[j] + eps), norm_Ctau2 * norm_Ctau2_list[j], &freestream, &profiles, &integralThickness, &integralDefect, &data.params_Ctau1_eps[j]);
            calculateEquationsParams(norm_delta * norm_delta_list[j], norm_A * norm_A_list[j], norm_B * norm_B_list[j], norm_Psi * norm_Psi_list[j], norm_Ctau1 * norm_Ctau1_list[j], norm_Ctau2 * (norm_Ctau2_list[j] + eps), &freestream, &profiles, &integralThickness, &integralDefect, &data.params_Ctau2_eps[j]);
        ...
        for (j = 0; j < nf; j++) {
            ...
            grad_size = (data.faces_connection[j].n + 1) * 6;
            grad_obj_func = (double *)malloc(grad_size * sizeof(double));
            data.obj_func = (double *)malloc((grad_size + 1) * sizeof(double));
            data.face = j;

            /* Calculate reference value */
            calculateDivergents(data.face, data.faces, data.vertices_connection, data.params, data.facesArea[j], data.p1, data.p2, data.p3);
            calculateGradients(data.face, data.faces, data.vertices_connection, data.params, data.e1, data.e2, data.e3, data.p1, data.p2, data.p3, data.velNorm, data.velx, data.vely, data.velz, data.transpiration);

            /* Surface shear stress */
            tau_x[data.face] = data.params[data.face].tau_w_x;
            tau_y[data.face] = data.params[data.face].tau_w_y;

            /* Ref. obj. func. */
            calculateObjectiveFunction(data.params[data.face], &data.obj_func[0], &data.max_momentum_x_aux, &data.max_momentum_y_aux, &data.max_kinetic_energy_aux, &data.max_lateral_curvature_aux, &data.max_shear_stress_x_aux, &data.max_shear_stress_y_aux, data.freestreamNorm);

            /* Asing error */
            if (data.obj_func[0] > max_error) {
                max_error = data.obj_func[0];
                max_momentum_x = data.max_momentum_x_aux;
                max_momentum_y = data.max_momentum_y_aux;
                max_kinetic_energy = data.max_kinetic_energy_aux;
                max_lateral_curvature = data.max_lateral_curvature_aux;
                max_shear_stress_x = data.max_shear_stress_x_aux;
                max_shear_stress_y = data.max_shear_stress_y_aux;
            }

            // Gradient
            objFuncGradient(grad_size, data, grad_obj_func);

            grad_norm = 0.0;
            for (k = 0; k < grad_size; k++) grad_norm = grad_norm + grad_obj_func[0] * grad_obj_func[0];
            grad_norm = sqrt(grad_norm);

            if (grad_norm < 0.001) {
                step = step_ref / (1000 * grad_norm);
                if (step > 1e-1) step = 1e-1;
            }
        ...
        if (i > 3000) {
            ...
            /* Transpiration */
            for (j = 0; j < nf; j++) {
                data.transpiration[j] = absValue(data.params[j].div_M) / density;
                tau_x[j] = data.params[j].tau_w_x;
                tau_y[j] = data.params[j].tau_w_y;
            }

            /* Solve linear system with zero transpiration */
            calculateDoubletDistribution(nf, matrix, array, data.transpiration, doublet);
